...
def parse_args():
    ...
    parser.add_argument('--epoch_num', type=int, default=5001)
    ...
    parser.add_argument('--data_folder', type=str, default='CIFAR100_data')
...
def parse_args_fid():
    ...
    parser.add_argument('--folder_path', type=str,
                        default='CIFAR100_Simulations/Folder_BaryTransfer_[90, 91, 92, 93, 94, 95, 96, 97, 98, 99]Full115/FID_Images')
